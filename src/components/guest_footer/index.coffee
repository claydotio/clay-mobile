      ...
      z '.l-content-container.l-flex.content',
        z 'section.section',
          ...
          z 'div.l-flex.links-container',
            z 'ul.links',
              z 'li', z "a[href=https://#{config.HOST}/blog]", 'Blog'
              z 'li', z "a[href=https://#{config.HOST}/about]", 'Team'
              z 'li', z 'a[href=mailto:jobs@clay.io' +
                        '?Subject=Let\'s change the world]', 'Jobs'
            z 'ul.links',
              z 'li', z 'a[href=/dashboard/contact]', 'Contact'
              z 'li', z "a[href=https://#{config.HOST}/tos]", 'Terms'
              z 'li', z "a[href=https://#{config.HOST}/privacy]", 'Privacy'
        z '.section',
          z 'h3.title', 'Connect'
          $socialIcons
        z 'section.clay-info',
